...
{ count == 5 && (
            <div className="flex bg-gradient-to-br from-[#5BAAB8] to-[#FF6B6B] w-screen h-screen">
                ...
                <div className="flex-a  m-auto w-2/5 h-3/5 rounded-xl">
                    <div className="">
                        <div className="text-center text-3xl text-white pt-10">Thank You for Answering!</div>
                        <div className="text-center text-xl text-white py-5">Click the link below to go to Dashboard</div>
